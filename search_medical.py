...
fklinks=open("links_meds_%s.csv"%strftime("%d%Y%m%H%M%S",localtime()),'w')
print fklinks
...
for num in range(50):
	#sleep(randint(20,50))
	url=requests.get("http://m.flipkart.com/m/academic-and-professional-books-3540/%d?__agent=mobile&layout=grid"%num, headers={'User-agent':'Mozilla/5.0 (X11; Linux i686; rv:7.0.1) Gecko/20100101 Firefox/7.0.1'},proxies=proxy)
	soup=BeautifulSoup(url.content)
